        ...
        <div class="card-body">
            ...
            <form action="register.php" method="post">
              ...
              <?= !empty($errors['name-register']) ? ' is-invalid' : ''?>"
                           value="<?=htmlspecialchars($formData['name-register'])?>">
              ...
              <?=!empty($errors['email-register']) ? ' is-invalid' : ''?>"
                           value="<?=htmlspecialchars($formData['email-register'])?>">
                    <div class="input-group-append">
                        <div class="input-group-text">
              ...
              <?=!empty($errors['password1']) ? ' is-invalid' : ''?>"
                           value="<?=htmlspecialchars($formData['password1'])?>">
                    <div class="input-group-append">
                        <div class="input-group-text">
                    ...
                    <?=!empty($errors['password1']) ?
                        '<span id="pass1-error" class="error invalid-feedback">' .
              ...
              <?=!empty($errors['password2']) ? ' is-invalid' : ''?>"
                           value="<?=htmlspecialchars($formData['password2'])?>">
                    <div class="input-group-append">
                        <div class="input-group-text">
                            <span class="fas fa-lock"></span>
                        </div>
                    ...
                    <?=!empty($errors['password2']) ?
                        '<span id="pass2-error" class="error invalid-feedback">' .
            ...
            <a href="index.php" class="text-center">В мене вже є аккаунт</a>
        </div>
        <!-- /.form-box -->
    </div><!-- /.card -->
</div>
